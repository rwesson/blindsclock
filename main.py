...
# update notification if it has been created
  ...
  def show_prizes(self):
    ...
    content.add_widget(InfoLabel(text="players      3rd   2nd   1st",font_name="RobotoMono-Regular"))
    content.add_widget(InfoLabel(text="20+          20    30    the rest",font_name="RobotoMono-Regular"))
    content.add_widget(InfoLabel(text="15+          15    25    the rest",font_name="RobotoMono-Regular"))
    content.add_widget(InfoLabel(text="10+          10    15    the rest",font_name="RobotoMono-Regular"))
    content.add_widget(InfoLabel(text="6+            5    10    the rest",font_name="RobotoMono-Regular"))
    content.add_widget(InfoLabel(text="up to 6       0     5    the rest",font_name="RobotoMono-Regular"))
