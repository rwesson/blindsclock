...
requirements = python3,kivy,chardet,idna,datetime,android,plyer,android-notify,oscpy
...
presplash.filename = %(source.dir)s/graphics/loading.png
...
icon.adaptive_foreground.filename = %(source.dir)s/graphics/icon.png
